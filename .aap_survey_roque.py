...
SURVEYS = [
    ...
    (
        ...
        {
            "name": "",
            "description": "add_host_inventory.yml — host em INV-ROQUE-LAB + grupos (role + grupo); credencial CRED-AAP-ROQUE",
            "spec": [
                q_text(
                    "host_name",
                    "Nome do host (curto)",
                ...
                q_text(
                    "host_description",
                    "Descrição",
                    "Campo description do host no inventário",
                    "Provisioned by Ansible",
                    False,
                    512,
                ),
                q_multi(
                    "host_role",
                    "Grupo por função (role)",
                    ["webserver", "database", "app", "bastion"],
                    "Cria/associa este grupo no inventário",
                    "webserver",
                    False,
                ),
                q_multi(
